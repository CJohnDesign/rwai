...
export function WhitelistOverlay({
  topOffset = "top-0 md:top-[70px]",
}: WhitelistOverlayProps) {
  ...
  return (
    <div
      className={`fixed inset-0 ${topOffset} z-40 bg-gradient-to-br from-white/80 to-gray-100/90 dark:from-black/70 dark:to-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-300`}
    >
      <div className="bg-card/98 border border-border/50 rounded-xl max-w-md w-full p-4 sm:p-8 shadow-2xl animate-in slide-in-from-bottom-8 fade-in duration-500 delay-150 relative mt-[-5vh] mx-auto overflow-y-auto max-h-[90vh]">
        <div className="text-center flex flex-col gap-4 sm:gap-6">
          ...
          <p className="text-sm sm:text-base text-muted-foreground">
            Be part of the revolution in AI infrastructure. Join our whitelist
            to access exclusive tokenized AI resources and early investment
            opportunities.
          </p>
          ...
          <div className="space-y-2 sm:space-y-3 -mt-4">
            <div className="flex items-center gap-2 text-xs sm:text-sm text-left">
              <div className="h-4 w-4 sm:h-5 sm:w-5 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
                <span className="text-[8px] sm:text-xs text-primary font-medium">
                  1
                </span>
              </div>
          ...
          <Link href={getMainUrl("whitelist")} rel="noopener noreferrer">
            <Button
              size="lg"
          ...
          <p className="text-xs text-muted-foreground">
            Limited spots available. Secure your position in the future of
