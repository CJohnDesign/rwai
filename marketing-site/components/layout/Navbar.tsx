...
import { Moon, Sun, X, Menu, Twitter, ExternalLink } from "lucide-react";
            ...
            <div className="flex flex-col space-y-6">
              ...
              >
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 mr-4 group-hover:bg-primary/10">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 text-gray-600 dark:text-gray-400 group-hover:text-primary dark:group-hover:text-primary"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
