        ...
        <div className="flex flex-col justify-center space-y-8 animate-fade-in animation-delay-200">
          <div className="space-y-6">
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
              Join the revolution in AI infrastructure ownership. Invest in high-performance GPU servers and earn passive income through our innovative tokenization platform.
            </p>
            
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
              Transform the way AI compute is owned and accessed. Be part of the solution to the global AI compute shortage.
            </p>
            ...
            <div className="pt-4">
              ...
              >
                <a href="#features" className="py-6 px-8 flex items-center gap-2">
                  <span className="relative z-10">Discover Opportunities</span>
